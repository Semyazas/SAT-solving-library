...
def collect_files_ais() -> list[str]:
    return [f"inputs\\ais\\ais{i}.cnf" for i in range(6, 13, 2)]
...
def parse_inputs(args: list[str]) -> tuple[list[str], bool, bool, str, bool]:
    ...
    if input_type == "toy":
        ...
        prefix_map = {
            "utf20": "inputs\\utf20\\uf20-0",
            "uuf50": "inputs\\uuf50\\UUF50.218.1000\\uuf50-0",
            "uuf753": "inputs\\uuf753\\UUF175.753.100\\uuf175-0",
            "flat30": "inputs\\flat30\\flat30-",
            "flat50": "inputs\\flat50\\flat50-",
            "flat75": "inputs\\flat75\\ai\\hoos\\Research\\SAT\\GenGCP\\Flat75-180\\flat75-",
            "flat125": "inputs\\flat125\\ai\\hoos\\Research\\SAT\\GenGCP\\Flat125-301\\flat125-",
            "flat150": "inputs\\flat150\\ai\\hoos\\Research\\SAT\\GenGCP\\Flat150-360\\flat150-",
            "flat175": "inputs\\flat175\\ai\\hoos\\Research\\SAT\\GenGCP\\Flat175-417\\flat175-",
        }
